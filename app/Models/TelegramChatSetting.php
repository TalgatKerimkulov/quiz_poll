...
class TelegramChatSetting extends Model
{
    ...
    public static function defaults(): array
    {
        return [
            ...
            'source_locale' => (string) config('telegram.defaults.source_locale', 'en'),
            'target_locale' => (string) config('telegram.defaults.target_locale', 'ru'),
            'direction' => (string) config('telegram.defaults.direction', 'forward'),
